        ...
        <table className="table table-striped table-hover table-bordered text-center align-middle">
          <thead>
            <tr className="table-primary">
              <th align='center'>항공기 번호</th>
              <th align='center'>이미지</th>
              <th align='center'>항공기 이름</th>
              <th align='center'>노선번호</th>
              <th align='center'>출발지</th>
              <th align='center'>도착지</th>
              <th align='center'>출발시간</th>
              <th align='center'>도착시간</th>
              <th align='center'>좌석수</th>
              <th align='center'>잔여 좌석 수</th>
              <th align='center'>사용 중인 좌석 수</th>
              <th align='center' colSpan="2">비고</th>
            </tr>
          </thead>
              ...
              <tr key={flight.flightNo}>
                ...
                <td colSpan={2}>
                  <div className="btn-box">
                    <button className='btn btn-primary me-1'><Link to={`/flight/flight_update/${flight.flightNo}`}>수정</Link></button>
