...
const Adminsidebar = () => {
 ...
 <div className="adminsidebar sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div className="offcanvas-md offcanvas-end bg-body-tertiary" tabIndex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto w-100">
          <ul className="Admin_mainmenu nav nav-pills flex-column">
              <li>관리자 관리</li>
