    ...
    <section id="Quick">
      ...
      <div className="btn_search_box">
            ...
            <div className="btn_search btn_search3">
              <Link href="/user/checkin/user"><img src="/img/Checkin.png" alt="체크인"/>체크인</Link>
            </div>
            <div className="btn_search btn_search4">
              <Link href="/user/productFlightList"><img src="/img/search.png" alt="출도착 조회" />출도착 조회</Link>
            </div>
            <div className="btn_search btn_search5">
              <Link href="/bus"><img src="/img/bus.png" alt="공항버스 예약" />공항버스 예약</Link>
            </div>
          </div>
      </div>
    </section>
